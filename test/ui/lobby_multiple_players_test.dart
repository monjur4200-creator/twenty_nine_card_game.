...
/// Fake PresenceService that lets us simulate multiple players joining
...
void main() {
  ...
  group('Lobby Multiple Players Test', () {
    testWidgets('Lobby shows multiple players when they join',

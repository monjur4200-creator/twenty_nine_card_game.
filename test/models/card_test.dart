...
void main() {
  group('Card29', () {
    test('equality works correctly', () {
      ...
      const card2 = Card29(Suit.hearts, Rank.nine);
      const card3 = Card29(Suit.spades, Rank.nine);
    ...
    test('hashCode is consistent with equality', () {
      const card1 = Card29(Suit.clubs, Rank.jack);
      const card2 = Card29(Suit.clubs, Rank.jack);
    ...
    test('pointValue returns correct values for all ranks', () {
      expect(const Card29(Suit.spades, Rank.jack).pointValue, equals(3));
      expect(const Card29(Suit.diamonds, Rank.nine).pointValue, equals(2));
      expect(const Card29(Suit.clubs, Rank.ace).pointValue, equals(1));
      expect(const Card29(Suit.hearts, Rank.ten).pointValue, equals(1));
      expect(const Card29(Suit.hearts, Rank.king).pointValue, equals(0));
      expect(const Card29(Suit.hearts, Rank.queen).pointValue, equals(0));
      expect(const Card29(Suit.hearts, Rank.seven).pointValue, equals(0));
    });

    test('rank comparison uses Rank.value ordering', () {
      const jack = Card29(Suit.hearts, Rank.jack);
      const nine = Card29(Suit.hearts, Rank.nine);
      const ace = Card29(Suit.hearts, Rank.ace);
    ...
    test('cards of different suits are not equal', () {
      const card1 = Card29(Suit.hearts, Rank.jack);
    ...
    test('copyWith updates flags immutably', () {
      const card = Card29(Suit.spades, Rank.nine);

...
void main() {
  group('Smoke test: dealer rotation flow', () {
    late List<Player> players;
    late GameState gameState;
    final rng = Random(123); // fixed seed for reproducibility
    ...
    Player rightOf(Player dealer) {
      final idx = players.indexOf(dealer);
    ...
    test('run 2 quick rounds with dealer rotation', () {
      const rounds = 2;
